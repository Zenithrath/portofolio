...
type PersonalForm = {
  name: string; title: string; university: string; faculty: string; bio: string; location: string; quote: string; status: string;
};

const emptyForm: PersonalForm = { name: "", title: "", university: "", faculty: "", bio: "", location: "", quote: "", status: "Open to Work" };

function toForm(personal: Personal | null): PersonalForm {
  if (!personal) return emptyForm;
  return { name: personal.name, title: personal.title, university: personal.university, faculty: personal.faculty, bio: personal.bio, location: personal.location, quote: personal.quote, status: personal.status };
}
