...
export default function FooterSection({ personal, contacts = [] }) {
    ...
    const socialLinks = platforms.map(
        (platform) =>
            contacts.find((contact) => contact.platform === platform) || {
                platform,
            },
    );
    const institute =
    ...
    const domicile = personal?.location || "Location not specified";
                    ...
                    <div className="lg:justify-self-end">
                        ...
                        <div className="mt-3 flex items-center gap-2.5">
                            {socialLinks.map((contact) => {
                                ...
                                const className =
                                    "inline-flex h-10 w-10 items-center justify-center rounded-xl border border-white/[0.22] bg-[#151817] text-[#E8EAE6] transition duration-200 hover:-translate-y-0.5 hover:border-[#FF3D00] hover:bg-[#FF3D00] hover:text-white";
