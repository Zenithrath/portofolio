    ...
    return (
        <section className="w-full max-w-full border-b border-white/[0.12] py-7 sm:py-8 lg:py-10">
            <Reveal className="flex w-full max-w-full flex-col justify-between gap-5">
                <div className="gsap-reveal w-full max-w-full space-y-3">
                    ...
                    <h3 className="w-full max-w-full font-['Syne'] text-sm font-extrabold italic leading-tight text-white sm:text-base md:text-lg lg:text-xl" style={{ overflowWrap: "break-word", wordBreak: "break-word", whiteSpace: "normal" }}>
                        &quot;{personal.quote}&quot;
                    </h3>
                </div>
